...
const send: MessageHandler<any> =
    (typeof process.send === "function" && process.send.bind(process)) ||
    throwError(new WUDSError("Seems like process.send is not a function: The wpWatchProcess should be started with child_process.fork()"))
